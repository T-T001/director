...
from app.schemas.novel_promotion import NovelIntakePreviewRequest
...
@router.post("/{project_id}/intake-preview")
def intake_preview(
    project_id: str,
    payload: NovelIntakePreviewRequest,
